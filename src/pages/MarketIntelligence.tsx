  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-fadeIn">
      <div className="space-y-4">
        ...
        <div className="bg-purple-50/50 p-6 rounded-lg border border-purple-100/50">
      ...
      <section className="space-y-6">
        ...
        {marketTrends.map((trend) => (
          <div 
            key={trend.title} 
            className="bg-gradient-to-br from-white to-blue-50/50 rounded-lg p-6 shadow-sm border border-blue-100/50"
          >
